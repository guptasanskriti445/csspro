...
$data = $QueryFire->getAllData('','','SELECT s.*,c.name as category FROM categories c, categories s WHERE c.id=s.parent_id and s.is_deleted=0 ORDER BY c.id DESC');
...
?>
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Manage Sub Categories <button class="btn btn-primary float-right dev-add">Add Sub Category</button></h1>
        </div>
        <div class="col-sm-6">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="deleteModalLabel">Are you sure you want to delete this Sub Category</h5>
