...
if(!empty($_POST['user_action'])) {
  switch($_POST['user_action']) {
    case 'delivered':
      if($QueryFire->upDateTable("orders","id=".$_POST['id'],array('status'=>'delivered','delivery_date'=> date('Y-m-d H:i:s')))) {
...
?>
                ...
                <?php if(!empty($orders)) { $cnt=1;
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a class="btn btn-success btn-xs delivered-order mt-1" data-toggle="modal" data-target="#deliveredModal" data-id="<?php echo $order['id'];?>"> Delivered Order?</a> 
                    </td>
                  </tr>
                <?php } } ?>
              </tbody>
  ...
  <div class="modal fade" data-backdrop="static"  id="deliveredModal" tabindex="-1" aria-labelledby="deliveredModalLabel" aria-hidden="true">
    <form method="post">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="deliveredModalLabel">Are you sure you want to delivered this product</h5>
          ...
          <div class="modal-footer">
            ...
            <button type="submit" name="user_action" value="delivered" class="btn btn-outline-danger rounded-0">Yes, Delivered</button>
          </div>
        </div>
      </div>
    </form>
