...
if(isset($_POST['name'])) {
  ...
  $arr['mobile_no'] = '';
  $subject = trim($arr['name']). ' has requested for contact ';
  $txt = "
  <html>
  <head>
  </head>
  ...
  if(mail('shellysureshjain@gmail.com',$subject,$txt,$headers)) {
    if($QueryFire->insertData('contact_enquiry',$arr)) {
      $msg = '<h4 class="text-center text-primary">Thank you! We will contact you shortly.</h4>';
    } else {
      $msg = '<h4 class="text-center text-danger">Sorry unable to process your request</h4>';
    }
  } else {
    $msg = '<h4 class="text-center text-danger">Sorry unable to process your request</h4>';
  }
                    ...
                    <div class="col-lg-5 offset-lg-1 col-md-12 order-1 order-lg-2">
                        <div class="contact-page-side-content">
                            ...
                            <div class="single-contact-block">
                                ...
                                <p>212 Barrington Court New York, ABC</p>
                            </div>
                            <div class="single-contact-block">
                                <h4><i class="fa fa-phone"></i> Phone</h4>
                                <p>Mobile:+1 333 4040 5566</p>
                            </div>
                            <div class="single-contact-block last-child">
                                <h4><i class="fa fa-envelope-o"></i> Email</h4>
                                <p>contact@company.com</p>
                                <p>support@rica.company</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="contact-form">
                                <form id="contact-form" action="" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mobile_no" id="con_email" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Subject</label>
